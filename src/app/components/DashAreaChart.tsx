...
export default function DashAreaChart() {
  return (
    <div className="p-6 rounded-xl shadow-xl text-white bg-[linear-gradient(126.97deg,_rgba(6,11,40,0.74)_28.26%,_rgba(10,14,35,0.71)_91.2%)]" >
      ...
      <div className="h-[320px] mt-4">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <YAxis stroke="#94a3b8" axisLine={false} tickLine={false} domain={[0, 'dataMax']} ticks={[0, 100, 200, 300, 400, 500]} />
            <Tooltip
